...
const NextRestaurant = ({ route, navigation }) => {
    ...
    const [bidPrice, setBidPrice] = React.useState(20);
        ...
        return (
            ...
            <View>
                ...
                >
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>Live Proposals</Text>
                        <Text style={{ ...FONTS.h3 }}>Bid</Text>
                    </View>
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>1st place</Text>
                        <Text style={{ ...FONTS.h3 }}>No bids</Text>
                    </View>
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>2nd place</Text>
                        <Text style={{ ...FONTS.h3 }}>No bids</Text>
                    </View>
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>3rd place</Text>
                        <Text style={{ ...FONTS.h3 }}>No bids</Text>
                    </View>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Text style={{ ...FONTS.h2 }}>Rs:{bidPrice.toFixed(2)}</Text>
                                <Text>{kg} Per Kg</Text>
                            </View>
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: COLORS.white, ...FONTS.h2 }}>Upload Your Bid</Text>
                        </TouchableOpacity>
                    </View>
                </View>
